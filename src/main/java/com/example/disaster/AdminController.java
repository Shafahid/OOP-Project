...
public class AdminController {
    ...
    @FXML
    private Button Dashboard, AssignTasks;
    ...
    public void AdminDashboard(ActionEvent e) {
        try {
            ...
            System.out.println("Error loading AdminDashboard.fxml: " + event.getMessage());
        }
    }
    ...
    public void AdminTaskAssign(ActionEvent e) {
        try {
            ...
            event.printStackTrace();
            System.out.println("Error loading AdminTaskAssign.fxml: " + event.getMessage());
        }
    }
